...
document.addEventListener('DOMContentLoaded', function () {
    ...
    nextButton.addEventListener('click', function (event) {
        ...
        } else if (selectedEvent.includes('Mr. & Ms. Technovation')) {
            window.location.href = 'register-pages/register-m&mt.html';
        } else {
...
document.getElementById('m&mtImage').addEventListener('click', function () {
    location.href = 'events/m&mt.html';
});
    ...
    nextButton.addEventListener('click', function (event) {
        ...
        if (selectedEvent.textContent === 'Select an Event') {
            ...
            if (selectedEvent.textContent.includes('HackVenture')) {
                ...
                window.location.href = 'register-pages/register-qt.html';
            } else if (selectedEvent.textContent.includes('Mr. & Ms. Technovation')) {
                window.location.href = 'register-pages/register-m&mt.html';
            }
        }
    });
